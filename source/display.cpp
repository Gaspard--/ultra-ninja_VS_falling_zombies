...
void    Display::displayInterface(void)
{
  ...
  displayText("Score   " + std::to_string(logic.getScore()), 256, {0.1f, 0.1f}, {-1.0 / dim[0], 0.72}, {1, 0}, {1.0, 1.0, 1.5});
  displayText("Time   " + logic.getTime(), 256, {0.1f, 0.1f}, {-1.0 / dim[0], 0.5}, {1, 0}, {1.0, 1.0, 1.0});
